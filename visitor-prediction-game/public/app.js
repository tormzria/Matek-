...
function initMap() {
  ...
  // Standard OpenStreetMap tiles (free, keyless, single host per current
  // OSM tile usage policy - no {s} subdomain sharding). Recolored dark via
  // CSS filter on .leaflet-tile-pane since free keyless dark basemap tile
  // services (e.g. CARTO's raster basemaps) now require an API key.
